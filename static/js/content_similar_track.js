...
//     $.post("./page/get_playing_informaton_local.php",
...
//     $.post("./page/dl_recommendation/get_similar_content_track.php",
//         {"song_id" : song_id},
...
function click_play_juno_track(juno_id, track_url) {
    ...
    $.post("./page/dl_recommendation/get_juno_informaton_local.php",
        {"juno_id" : juno_id,
        "track_url" : track_url},
        function(data,status){
            var data_obj = JSON.parse(data);
